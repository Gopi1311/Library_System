...
const AppLayout: React.FC<LayoutProps> = ({ children, navigation, user }) => {
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      `}>
        ...
        <div className="p-4 bg-gray-50 flex items-center space-x-3">
          <div className="w-8 h-8 bg-blue-600 text-white font-bold flex items-center justify-center rounded-lg">L</div>
